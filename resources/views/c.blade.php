...
.button2{
  border-radius: 20px; width:100px; height:30px;
...
<!-- Start Nagigation -->
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark pl-5 fixed-top" style="background-color:#25274D !important ">
   ...
   <li class="nav-item" style="margin-left: 200px;"><a href="profile" class="nav-link"><i class="fa fa-user-circle " style="color:#DDDDDD;">&nbsp;&nbsp;{{ Auth::user()->email }}</i> 
    </a></li>
  </ul>
 </div>
...
<!-- Course content -->
  <div class="container-fluid bg-dark" id="main">
    ...
    <a href="/txntest"><button class="button button2">Enroll Now</button></a>
    </div>
  <div class="row A">
...
<div class="container col-md-6" >
 <center><h5>Get started with C Programming Language Course</h5></center>
  <a href="/txntest"><center><button class="button button2" style="margin-bottom: 20px; margin-top: 5px;">Enroll Now</button></center></a>
</div>
