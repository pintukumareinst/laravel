...
<!-- Start Nagigation -->
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark pl-5 fixed-top" style="background-color:#25274D !important ">
   ...
   <li class="nav-item" style="margin-left: 500px;"><a href="/profile" class="nav-link"><i class="fa fa-user-circle " style="color:#DDDDDD;"></i>&nbsp;{{ Auth::user()->email }}</a></li>
		...
		<table class="table table-striped table-hover table-sm">
			...
			<tbody>
				...
				<tr>
					...
					<td><input class="form-control" id="CUST_ID" tabindex="2" maxlength="12" size="12" name="CUST_ID" autocomplete="off"  value="{{ Auth::user()->email }}" ></td>
				</tr>
				<tr>
					<td>3</td>
